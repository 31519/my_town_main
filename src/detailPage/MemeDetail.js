...
import { memeDetailAction } from "../actions/advertiseActions";
import Loaders from "../components/Loader";
import ErrorMessage from "../components/ErrorMessage";
import Categories from "../components/Categories";
import MemeDetailCard from "../components/DetailCard";
          ...
          <div className="techlist">
            ...
            <Grid spacing={2} className={classes.gridContent} container>
              ...
              {detailMemeLoading ? (
                ...
                <ErrorMessage type="error" error={detailMemeError} />
              ) : (
                <Grid spacing={1} item xs={12} sm={6} lg={6} md={6}>
                  
                    <MemeDetailCard key={detailMeme.id} item={detailMeme}/>
