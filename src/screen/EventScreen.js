...
import { eventListAction } from "../actions/advertiseActions";
...
const EventScreen = () => {
  ...
  useEffect(() => {
    dispatch(eventListAction(keyword));
  ...
  return (
    <>
      <Helmet>
        <title>Inmatown - Latest Even/Scheme</title>
        <meta name="title" content="Inmatown - Latest Even/Scheme" />
        <meta name="description" content="latest Even/Scheme" />
      </Helmet>
      <SideBar />
      <Header />
      <SearchBox />
              ...
              <div>
                {listEvent.map((data) => (
                  <Link
                    ...
                    to={`/event-detail/${data.id}/${data.slug}`}
                  >
